    ...
    <section className="relative px-6 md:px-12 pt-20 pb-16">
      <div className="max-w-3xl">
        ...
        <p className="text-lg text-white/45 font-light max-w-lg leading-relaxed mb-3">
          Just a dude trying to figure out this Youtube stuff.
        </p>
        <p className="text-sm text-white/25 tracking-wide mb-10">
          Pakistan &mdash; Art · Books · Anime · Video Games
        </p>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <a href="https://instagram.com/zenetagram" target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-2 px-5 py-2.5 rounded-lg border border-white/10 text-white/60 hover:text-white hover:border-white/20 text-sm font-medium tracking-wide transition-colors">
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
